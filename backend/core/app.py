...
from backend.modules.module2.module2_engine import QUESTION_BANK,evaluate_answer,select_next,score_assessment
...
from backend.auth.auth_routes import auth,current_user,require_auth
from backend.auth.auth_db import init_db,record_performance,list_user_summaries,get_user_performance,get_user_activity
...
def admin_user(user_id):
    ...
    from backend.auth.auth_db import get_user_activity
