...
CREATE TABLE IF NOT EXISTS module_performance(
 id BIGSERIAL PRIMARY KEY,
 user_id UUID NOT NULL REFERENCES users(id) ON DELETE CASCADE,
 module TEXT NOT NULL CHECK(module IN ('module1','module2','module3','module4','module5')),
 score DOUBLE PRECISION NOT NULL CHECK(score >= 0 AND score <= 100),
 payload JSONB NOT NULL DEFAULT '{}'::jsonb,
 completed_at TIMESTAMPTZ NOT NULL DEFAULT NOW(),
 UNIQUE(user_id,module)
);
CREATE INDEX IF NOT EXISTS idx_module_performance_user ON module_performance(user_id);
CREATE INDEX IF NOT EXISTS idx_module_performance_module ON module_performance(module);
"""
...
def record_performance(user_id,module,score,payload=None):
    ...
    with db_connect() as conn:
        with conn.cursor() as cur:
            cur.execute('INSERT INTO module_performance(user_id,module,score,payload,completed_at) VALUES(%s,%s,%s,%s,NOW()) ON CONFLICT(user_id,module) DO UPDATE SET score=EXCLUDED.score,payload=EXCLUDED.payload,completed_at=NOW()', (user_id,module,value,json.dumps(payload or {})))
